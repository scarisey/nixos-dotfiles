{config, ...}: let
  ...
  ipv4 = config.scarisey.server.settings.hyperion.ipv4;
  ipv6 = config.scarisey.server.settings.hyperion.ipv6;
  localSslPort = config.scarisey.server.settings.hyperion.ssl.local.port;
  remoteSslPort = config.scarisey.server.settings.hyperion.ssl.remote.port;
